...
const features = [
  {
    ...
    description: "Tus clientes exigen respuestas rápidas. Nuestro sistema atiende consultas al instante, ya sea domingo a las 3 PM o martes a las 2 AM.",
    visual: "deploy", // Puedes mantener los visuales animados originales, encajan perfecto
  },
  {
    number: "02",
    title: "Cualificación de Leads",
    description: "La IA no solo saluda; hace las 3 preguntas clave de tu negocio para separar a los curiosos de los clientes dispuestos a pagar.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Sincronización Total",
    description: "Cada cliente calificado se exporta automáticamente a tu Google Sheets o se agenda directo en tu Calendario. Cero trabajo manual.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Avisos Inteligentes",
    description: "Solo te interrumpimos cuando importa. Recibe notificaciones directamente en tu teléfono cuando un 'Lead Caliente' requiere cierre humano.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="mb-16 lg:mb-24">
          ...
          <h2 className={`text-4xl lg:text-6xl font-display tracking-tight text-foreground transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            Diseñado para facturar.<br />
            <span className="text-secondary">No para complicarte la vida.</span>
          </h2>
        </div>
