...
def obtener_instrucciones_seguras(client_id: str) -> str:
    ...
    12. CONTINUIDAD Y CLIENTES QUE RETOMAN: Si la charla es continua, no repitas saludos, ve directo a la respuesta. Si el cliente te vuelve a saludar (ej: "Hola") después de horas o días, asume que es una nueva consulta. Saludalo de forma corta y profesional (Ej: "Hola! En qué te puedo ayudar hoy?"). TIENES ESTRICTAMENTE PROHIBIDO decir "¡Hola de nuevo!" o "¿Cómo andás?".
